...
def plot_hist_low_level(Time, Light, Mode, PIR_ON_OFF, THPL_ON_OFF, State_Trans, Reward,
    ...
    ax4 = plt.subplot(514)
    plt.plot(Time, PIR_ON_OFF, 'y.', label = 'Action', markersize = 15)
    plt.ylabel('PIR\nOn_Off\n[num]', fontsize=15)
    #plt.xlabel('Time [h]', fontsize=20)
    #plt.legend(loc=9, prop={'size': 10})
    plt.ylim(0)
    ...
    plt.plot(Time, THPL_ON_OFF, 'y.', label = 'Action', markersize = 15)
    plt.ylabel('THPL\nOn_Off\n[num]', fontsize=15)
    #plt.xlabel('Time [h]', fontsize=20)
    #plt.legend(loc=9, prop={'size': 10})
    plt.ylim(0)
